...
namespace fv
{
    defineTypeNameAndDebug(turbineFALSource, 0);
...
void Foam::fv::turbineFALSource::rotateVector
(
...
void Foam::fv::turbineFALSource::createCoordinateSystem()
{
    // Should be unique for each type of turbine
}


void Foam::fv::turbineFALSource::createBlades()
{
    // Should be unique for each type of turbine
}


void Foam::fv::turbineFALSource::createOutputFile()
{
    fileName dir;
...
void Foam::fv::turbineFALSource::updateTSROmega()
{
...
void Foam::fv::turbineFALSource::rotate()
{
...
void Foam::fv::turbineFALSource::rotate(scalar radians)
{
    // Should be defined for each turbine type
}


void Foam::fv::turbineFALSource::printPerf()
{
...
Foam::fv::turbineFALSource::turbineFALSource
(
    const word& name,
...
void Foam::fv::turbineFALSource::addSup
(
    fvMatrix<vector>& eqn,
    const label fieldI
)
...
void Foam::fv::turbineFALSource::printCoeffs() const
{
    Info<< "Number of blades: " << nBlades_ << endl;
}


void Foam::fv::turbineFALSource::writePerf()
{
...
void Foam::fv::turbineFALSource::writeData(Ostream& os) const
{
...
bool Foam::fv::turbineFALSource::read(const dictionary& dict)
{
