...
#include "axialFlowTurbineFlexibleALSource.H"
...
namespace fv
{
    defineTypeNameAndDebug(axialFlowTurbineFlexibleALSource, 0);
    addToRunTimeSelectionTable
    (
        option,
        axialFlowTurbineFlexibleALSource,
        dictionary
    );
}
}
...
void Foam::fv::axialFlowTurbineFlexibleALSource::createCoordinateSystem()
{
...
void Foam::fv::axialFlowTurbineFlexibleALSource::createBlades()
{
...
void Foam::fv::axialFlowTurbineFlexibleALSource::createHub()
{
    int nElements;
    List<List<scalar> > elementData;
...
void Foam::fv::axialFlowTurbineFlexibleALSource::createTower()
{
...
void Foam::fv::axialFlowTurbineFlexibleALSource::createNacelle()
{
    // Do nothing
}


void Foam::fv::axialFlowTurbineFlexibleALSource::calcEndEffects()
{
    if (debug)
    {
...
Foam::fv::axialFlowTurbineFlexibleALSource::axialFlowTurbineFlexibleALSource
(
    const word& name,
    ...
    )
{
    ...
    if (debug)
    {
        Info<< "axialFlowTurbineFlexibleALSource created at time = " << time_.value()
            << endl;
    }
}
...
void Foam::fv::axialFlowTurbineFlexibleALSource::rotate(scalar radians)
{
    if (debug)
    {
...
void Foam::fv::axialFlowTurbineFlexibleALSource::yaw(scalar radians)
{
    if (debug)
    {
...
void Foam::fv::axialFlowTurbineFlexibleALSource::addSup
(
    fvMatrix<vector>& eqn,
    const label fieldI
)
...
void Foam::fv::axialFlowTurbineFlexibleALSource::printCoeffs() const
{
    Info<< "Number of blades: " << nBlades_ << endl;
}


bool Foam::fv::axialFlowTurbineFlexibleALSource::read(const dictionary& dict)
{
